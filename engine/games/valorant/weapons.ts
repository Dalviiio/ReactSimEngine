/**
 * Catalogue des armes/armures. Valeurs calquées au mieux sur les vraies stats
 * Valorant (patchs récents), pas garanties pixel-perfect — plausibles et
 * cohérentes entre elles, ajustables plus tard sans changer les types/API.
 *
 * Simplification volontaire pour les fusils à pompe (Shorty/Bucky/Judge), qui
 * tirent normalement plusieurs projectiles : ici un seul "dégât effectif par
 * tir" agrégé, pas de simulation projectile par projectile.
 */
...
export interface Weapon {
   ...
   * = dégâts constants quelle que soit la distance (ex: Vandal). Plusieurs paliers
   * = dropoff progressif (ex: Phantom).
   */
