...
/** Bonus pour TOUS les attaquants vivants/morts s'ils ont posé la charge, même si la manche est perdue ensuite. */
export const DEVICE_PLANT_BONUS = 300;
/** Bonus additionnel (en plus du gain de manche) si la charge explose. */
export const DEVICE_DETONATION_BONUS = 300;
